...
import com.ewertonilima.dscatalog.tests.TokenUtil;
...
public class ProductResourceTests {
	...
	void setUp() throws Exception {
		...
		when(productService.post(ArgumentMatchers.any())).thenReturn(productDTO);
		
		when(productService.update(ArgumentMatchers.eq(existingId), ArgumentMatchers.any())).thenReturn(productDTO);
		when(productService.update(ArgumentMatchers.eq(nonExistingId), ArgumentMatchers.any())).thenThrow(ResourceNotFoundException.class);
	...
	@Test
	public void postShouldReturnProductDTOCreated() throws Exception {
